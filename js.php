  <!-- Chat -->
    ...
    <!-- Layout -->
    <audio id="video">
        <source src="button-09a.wav" type="audio/mpeg">
    </audio>
    <!-- Modal: Invite -->
                ...
                <div class="modal-body py-0">
                    ...
                    <div class="profile modal-gx-n">
                        ...
                        <div class="profile-body">
                            ...
                            <p>last seen <?php echo $last_seen; ?></p>
                        </div>
                    </div>
                    <!-- Header -->
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <a href="javascript:void(0)" id="logout" class="text-danger">Logout</a>
                        </li>
                    </ul>
                    <!-- List -->
                </div>
                ...
                <div class="modal-body py-0">
                    ...
                    <div class="profile modal-gx-n">
                        ...
                        <div class="profile-body">
                            ...
                            <h4 class="mb-1"><?php echo $_SESSION['username']?></h4>
                            <p>last seen <?php echo $last_seen; ?> ago</p>
                        </div>
                    </div>
                    <!-- Header -->
